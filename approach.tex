...
\begin{table*} 
        ...
        \begin{tabular}{ l c c c } 
         \toprule
                System & CEs / node / year & GiB / node & CEs / node / year\\
         \midrule
                Schroeder et al~\cite{Schroeder:09:dram}  & 22,696 & 1--4 & 11,384\\
                Facebook~\cite{meza:2015:revisiting} & 5,964 & 2--24 & 460\\ % median 108 CEs/ node / year
                Cielo~\cite{levy:2018:lessons} & 22.5 & 32 & 0.7 \\
         \bottomrule
        \end{tabular}
        \vspace{.6em}
        \caption{ 
