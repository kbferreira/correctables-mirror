...
\begin{table*} 
        ...
        \begin{tabular}{ l c c c c } 
         ...
         \midrule
                ...
                Facebook~\cite{meza:2015:revisiting} & 5,964 & 2--24 & 460 & 1.47\\ % median 108 CEs/ node / year
                Cielo~\cite{levy:2018:lessons} & 22.5 & 32 & 0.7 & 385 \\ % 285 TiB
                Trinity~\cite{Trinity} (hypothetical w/ $CE_{Cielo}$)  &  89.6 & 128 & 0.7 & 100\\   % 2 PiB 16Knodes
                Summit~\cite{Summit} (hypothetical w/ $CE_{Cielo}$)  &  425.6 & 608 & 0.7 & 20\\   % 10 PiB 4Knodes
