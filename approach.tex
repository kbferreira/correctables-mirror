...
(CMCI)~\cite{IntelGuide,Gottscho:2016:Measuring} is generated which records
...
to memory organization~\cite{Gottscho:2016:Measuring}.  As a result, mitigating
...
passed to system software~\cite{Gottscho:2016:Measuring}. SMM mode is expensive
...
\kbf{Add application workloads here ...}
